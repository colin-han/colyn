...
提示：
  ...
  ? - Untracked (未被 git 跟踪的新文件)`,
    ...
    release: {
      ...
      runningPublish: '发布到包管理服务...',
      checkingPublishable: '检查工具链可发布性...',
      publishSucceeded: '已发布到包管理服务',
      publishSkippedForToolchain: '跳过 {{toolchain}}（{{path}}）：不满足发布条件',
      publishSkippedAll: '未找到可发布的工具链，已跳过发布阶段',
      publishSkippedSummary: '已跳过 {{count}} 个不满足发布条件的工具链',
      pushFailed: '推送失败',
