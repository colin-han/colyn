...
Hints:
  ...
  ? - Untracked (new files not in git)`,
    ...
    release: {
      ...
      step3: 'Step 3: Run code quality check',
      step4: 'Step 4: Build project',
      step5: 'Step 5: Update package.json',
      step6: 'Step 6: Create git commit',
      step7: 'Step 7: Create git tag',
      step8: 'Step 8: Push to remote',
