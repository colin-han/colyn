...
Hints:
  ...
  ? - Untracked (new files not in git)`,
    ...
    release: {
      ...
      lintSkipped: 'Lint skipped (--no-build)',
      runningBuild: 'Running build...',
      buildSucceeded: 'Build succeeded',
      buildSkipped: 'Build skipped (--no-build)',
      versionStepSkipped: 'Skipped (--no-version-update)',
      tagSkipped: 'Tag creation skipped',
...
Main branch directory: {{path}}`,
      ...
      skippingBuild: 'Skipping lint and build checks (--no-build)',
...
Solution:
  Reinstall: npm install -g colyn`,
    ...
    todo: {
      ...
      uncomplete: {
        description: 'Revert a done todo back to in-progress',
        notFound: 'Todo "{{todoId}}" not found',
        notCompleted: 'Todo "{{todoId}}" is not in done status',
        noBranch: 'Not in a worktree branch, please specify a Todo ID',
        success: 'Todo "{{todoId}}" reverted to in-progress',
        usingCurrentBranch: 'Using current branch name: {{branch}}',
      },
      complete: {
        description: 'Mark an in-progress todo as done',
        notFound: 'Todo "{{todoId}}" not found',
        notPending: 'Todo "{{todoId}}" is not in in-progress status',
        noPending: 'No in-progress tasks',
      ...
      migrateLocal: {
        ...
        itemFailed: 'Failed to migrate "{{todoId}}": {{error}}',
        summary: 'Migration done: {{migrated}} migrated, {{skipped}} skipped, {{failed}} failed',
