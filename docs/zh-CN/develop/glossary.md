...
**相关术语**：[Window Index](#window-indextmux-窗口索引)
...
**相关术语**：[Session Name](#session-nametmux-会话名称)
...
**相关术语**：[Dev Server](#dev-server开发服务器)
...
**相关术语**：[并行 Vibe Coding](#并行-vibe-coding)
...
**相关术语**：[Session Name](#session-nametmux-会话名称)、[Window](#windowtmux-窗口)
...
**相关术语**：[Project Name](#project-name项目名)、[Session](#sessiontmux-会话)
...
**相关术语**：[Window Index](#window-indextmux-窗口索引)、[Window Name](#window-name窗口名称)、[Pane](#panetmux-窗格)
...
**相关术语**：[Worktree ID](#worktree-id)、[Window](#windowtmux-窗口)
...
**相关术语**：[Branch Name](#branch-name分支名)、[Window](#windowtmux-窗口)
...
**相关术语**：[Window](#windowtmux-窗口)、[Dev Server](#dev-server开发服务器)
...
**相关术语**：[Base Port](#base-port基础端口)、[Dev Server](#dev-server开发服务器)
...
**相关术语**：[Base Port](#base-port基础端口)、[.env.local](#envlocal)
...
**相关术语**：[Worktree ID](#worktree-id)、[.env.local](#envlocal)
...
- **Colyn 需求文档**：`docs/requirement-tmux-integration.md`
- **Colyn 设计原则**：`CLAUDE.md`
- **用户故事**：
  - `blog/parallel-vibe-coding-with-colyn.md`
  - `blog/parallel-vibe-coding-2-with-tmux.md`
